...
function Home() {
  ...
  <>
   <div className='max-w-xl ml-20 text-white'>
    <div className='text-xl leading-normal tracking-widest text-left uppercase font-krona mt-14 mt-30'>Creative robotics</div>
    <div className='text-6xl leading-normal tracking-widest text-left text-white uppercase font-krona'>UOK ROBOT BATTLE</div>
    <div className='text-6xl leading-normal tracking-widest text-left text-white uppercase font-krona'>2K24</div>
    <div>
        <p className='font-semibold leading-normal tracking-widest text-left text-white'>
