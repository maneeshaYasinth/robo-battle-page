  ...
  return (
    <nav className="fixed top-0 left-0 z-50 w-full bg-[#00000066] shadow-[0px_4px_4px_#00000040] backdrop-blur-[50px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(50px)_brightness(100%)] font-transrobotics">
      <div className="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-20"> {/* Adjusted height */}
          {/* Logo */}
          ...
          <div className="hidden center sm:flex sm:items-center sm:ml-6 sm:space-x-4">
            <NavLink to="/#home" activeLink={activeLink} onClick={() => handleLinkClick("/#home")}>Home</NavLink>
            <NavLink to="/#rules" activeLink={activeLink} onClick={() => handleLinkClick("/#rules")}>Rules</NavLink>
            <NavLink to="/#about" activeLink={activeLink} onClick={() => handleLinkClick("/#about")}>About</NavLink>
            <NavLink to="/#timeline" activeLink={activeLink} onClick={() => handleLinkClick("/#timeline")}>Timeline</NavLink>
            <NavLink to="/#prizes" activeLink={activeLink} onClick={() => handleLinkClick("/#prizes")}>Prizes</NavLink>
            <NavLink to="/#contact" activeLink={activeLink} onClick={() => handleLinkClick("/#contact")}>Contact</NavLink>
          </div>
